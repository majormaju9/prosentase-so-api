...
const ALFASTORE_URL =
  "https://app.alfastore.co.id/prd/api/rpt/laporan/register_dokumen_toko_koreksi";
  ...
  try {
    ...
    if (!storeId || !periode1 || !periode2) {
      return NextResponse.json(
        {
          success: false,
          message: "storeId, periode1, dan periode2 wajib diisi",
        },
        { status: 400 }
      );
    }
    ...
    return NextResponse.json(
      {
        success: false,
        message:
          "Gagal mengambil Register Dokumen Toko Koreksi",
        error:
